...
class TA:virtual public Faculty,virtual public Student   //TA Class Created
                                                         //TA Inheriting Faculty and Student Class
                                                         //Virtual Used for Avoiding Diamond Problem
{
public:
    TA()
    {
    ...
    TA(string N,int A,string Add,string M,string BG,string Na,string U,string D,  //Parameterized Constructor
       string id,string SEM,float cgpa,string I,double S,string St,string G)
        :Faculty(N,A,Add,M,BG,Na,I,S,St,G),
         Student(N,A,Add,BG,Na,U,D,id,SEM,cgpa,G)
    {

    }
    ~TA()  //TA CLass Destructor
    {
...
int main()
{
    ...
    TA ta("Aysha",26,"Rajshahi","01815610901","B-","Bangladeshi","AIUB","CSE","16-76332-1","11 th",3.85,"AIUB",50000,"N/A","Female");
    cout<<"                    "<<endl;
